...
import 'package:focus_app/features/pomodoro/views/widgets/pomodoro/break_time_pop_up.dart';
import 'package:focus_app/features/pomodoro/views/screens/pomodoro/pomodoro_page.dart';
    ...
    return RepositoryProvider(
      ...
      child: MultiBlocProvider(
        providers: [
          ...
          BlocProvider(
            create: (context) => PromodorTaskBloc(taskRepo: context.read<TaskRepo>())..add(PromodorTaskEventOnSelectTask(task: task)),
          ),
          BlocProvider(
